...
const fetchConnectedUsers = () => {
  ...
  axios
    .get("https://squads-34fb4-default-rtdb.europe-west1.firebasedatabase.app/members/connected.json")
    .then((response) => {
...
const fetchTotalUsers = () => {
  ...
  axios
    .get("https://squads-34fb4-default-rtdb.europe-west1.firebasedatabase.app/members/total.json")
    .then((response) => {
